    ...
    <section id="contact" className="py-20 bg-[#080808] relative border-b border-neutral-900/60 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          {/* Prawa Kolumna: Formularz wizualny */}
            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-neutral-900/80 border border-neutral-800/80 rounded-md px-4 py-2.5 text-sm text-neutral-200 placeholder-neutral-600 focus:outline-none focus:border-red-500 transition-colors duration-200"
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full bg-neutral-900/80 border border-neutral-800/80 rounded-md px-4 py-3 text-sm text-neutral-200 placeholder-neutral-600 focus:outline-none focus:border-red-500 transition-colors duration-200 resize-none"
                />
              </div>
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="px-6 py-2.5 bg-red-600 hover:bg-red-700 text-white text-xs font-mono uppercase tracking-wider font-semibold rounded-md transition-all duration-200 shadow-lg shadow-red-900/20 cursor-pointer"
                >
                  Send Message
                </button>
              </div>
